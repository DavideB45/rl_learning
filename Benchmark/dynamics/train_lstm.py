...
if __name__ == '__main__':
	...
	dev = best_device()
	vq = load_vq_vae(CURRENT_ENV, CDODEBOOK_SIZE, CODE_DEPTH, LATENT_DIM, True, SMOOTHING, dev)
	lstm = LSTMQuantized(vq, dev, CURRENT_ENV['a_size'], 17, HIDDEN_DIM)
	tr = make_seq_dataloader_safe(get_data_path(CURRENT_ENV['data_dir'], True, 0), vq, SEQ_LEN, 128)
	vl = make_seq_dataloader_safe(get_data_path(CURRENT_ENV['data_dir'], False, 0), vq, SEQ_LEN, 128)
